    ...
    function submitHandler (e) {
        ...
        fetch('/crmtest.php', {
            ...
            .then(async (response) => {
                ...
                console.log(swipers[`swiper-${index + 1}`])
                await defay(3000)
                toggleBtnLoader(sunmbitBtn)
                startAnimation()
                if (!response.ok) {
...
// const swiperApplicationForm = new Swiper(applicationFormSwiperContainer, {
//
// })
...
// applicationForm.addEventListener('submit', submitHandler)
